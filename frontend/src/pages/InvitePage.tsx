...
export function InvitePage() {
  ...
  if (error && !invite) {
    return (
      <div className="min-h-screen bg-app-dark flex flex-col items-center justify-center p-6">
        <div className="w-full max-w-md rounded-2xl bg-app-channel p-8 text-center shadow-xl">
  ...
  return (
    <div className="min-h-screen bg-app-dark flex flex-col items-center justify-center p-6">
      <div className="w-full max-w-md rounded-2xl bg-app-channel shadow-xl overflow-hidden">
        ...
        <div className={`w-20 h-20 rounded-2xl flex items-center justify-center text-3xl font-bold text-white mb-4 mx-auto overflow-hidden ${invite.server.iconUrl ? 'bg-transparent' : 'bg-app-channel'} ${invite.server.bannerUrl ? '-mt-10 ring-4 ring-app-channel' : ''}`}>
        ...
        <h1 className="font-display text-2xl font-bold text-white mb-1">{invite.server.name}</h1>
