...
| **Deafen/mute were independent** | Deafen did not mute; unmuting while deafened left headphones off. | **Fix**: Discord-style coupling in `VoiceContext` / `CallContext` — deafen ⇒ mute; unmute ⇒ undeafen. |
