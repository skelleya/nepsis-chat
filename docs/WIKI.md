...
| + | User Settings GSAP — Modal opens/closes with GSAP; fixed panel height; content glides across a page strip (past intermediates) while sidebar selection jumps to the target |
