...
| + | User Settings GSAP — Modal opens/closes with GSAP; fixed panel height; settings pages are a horizontal strip that slides through intermediate tabs (e.g. My Account → Voice & Video) instead of flashing |
